      ...
      >
        ...
        <Container className={`mt-5 text-center`}>
          ...
          <Row className="my-4 py-4 text-start">
            ...
            <Col md={6}>
              <p>
                في شركتنا، نلتزم بأعلى معايير التنظيف  العالمية المتخصصة للمطابخ والفنادق.
                فريقنا من الفنيين المعتمدين متخصصون في  تنظيف أنظمة العادم بأعلى دقة، وإزالة تراكمات الشحوم للتقليل من مخاطر الحريق، وضمان بيئة صحية ونظيفة.
                نحن ندرك أهمية العناية المتواصلة بالمرافق الحيوية لعملائنا،
                ولهذا نقدم خدمات تنظيف متكاملة ، لتحقق أعلى درجات الأمان والجودة   .
              </p>
              <Button
