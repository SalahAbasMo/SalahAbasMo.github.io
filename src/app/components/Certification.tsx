    ...
    <Container id="certification" className="text-center">
      ...
      <Row className={`d-flex align-items-center mb-5`}>
        ...
        <Col className={`mb-5`} md={12}>
          <h6 className={`mb-5`}>
            نحن متخصصون في تنظيف هود وضكت ومراوح وفلاتر مطابخ الفنادق والمطاعم, نهدف إلى تحقيق أعلى مستويات النظافة والكفاءة. يتميز فريقنا من الفنيين المدربين بتطبيق أحدث تقنيات التنظيف لإزالة الشحوم والأوساخ العنيدة التي تتراكم على مر الزمن، مما يسهم في تحسين جودة الهواء وتقليل المخاطر المحتملة على الصحة والسلامة. من تنظيف عوادم المطابخ وأنظمة التهوية إلى تعقيم الأسطح والأجهزة، نضمن لك بيئة نظيفة وصحية تلبي المعايير الصارمة للمطابخ التجارية والفنادق. دع فريقنا من الخبراء يهتم بجميع تفاصيل النظافة، لتحصل على بيئة آمنة وملائمة للعمل والضيافة."
          </h6>
        </Col>
